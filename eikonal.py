...
def calcTrace (p_1, p_2, p_3, p_4, p_s):
    ...
    chi_1= 1-(t*u)/pow(s,2)-(t*s)/pow(u,2)-(pow(t,2))/(s*u)
    chi_2= (t*s)/pow(u,2)-(t*u)/pow(s,2)+pow(u,2)/(s*t)-pow(s,2)/(t*u)
    chi_3= 27./4.-9.*((s*u)/pow(t,2)+(1./4.)*((t*u)/pow(s,2))+(1./4.)*((t*s)/pow(u,2)))+(9./2.)*(pow(u,2)/(s*t)+pow(s,2)/(t*u)-(1./2.)*((pow(t,2))/(s*u)))
    
    M=np.array([[1.,0,0,0,0],[0,8.,0,0,0],[0,0,8,0,0],[0,0,0,20.,0],[0,0,0,0,27.]])
    
    H=(1./16.)*np.array([[9.*chi_1,(9./2.)*chi_1,(9./2.)*chi_2,0,-3.*chi_1],[(9./2.)*chi_1,(9./4.)*chi_1,(9./4.)*chi_2,0,(-3./2.)*chi_1],[(9./2.)*chi_2,(9./4.)*chi_2,chi_3,0,(-3./2.)*chi_2],[0,0,0,0,0],[-3.*chi_1,(-3./2.)*chi_1,(-3./2.)*chi_2,0,chi_1]])

    C_12 = np.array([[0,0,3./8.,0,0.],[-3./5.,-8./5.,-12./5.,0,-3./5.],[3,8./9.,1,0,1./3.],[-3./2.,11./27.,1./2.,0,7./6.],
                     [21./10.,31./10.,7./2.+1./40.,3./2.,21./10.]])
                     
    C_13 = np.array([[3,0,0,0,0.],[0,3./2.,0,0,0],[0,0,3./2.,0,0],[0,0,0,0,0],
                     [-3, -3./.2,3./2.,0,0]])
                     
    C_14 = np.array([[0,0,-3./8.,0,0.],[-3./5.,-8./5.,12./5.,0,-3./5.],[3,8./9.,-1,0,1./3.],[-3./2.,11./27.,-1./2.,0,7./6.],
                     [21./10.,31./10.,-7./2.-1./40.,-3./2.,21./10.]])
